...
config.read('D:/工作项目/Pyqt5/G_CONFIG/config.ini', encoding='utf-8')

# try:
#     self.con_model = config.get('Metagenome', 'model_list')
#     self.model_list = self.con_model.split(',')
# except:
#     QMessageBox.warning(self, '警告', '配置文件中模型列表参数有误！', QMessageBox.Ok)
...
class Ui_Dialog(QWidget):
    ...
    def receive_param(self):
        ...
        if not ori_path or not list_path or not threads_ or not result_path or not model_name or not count:
