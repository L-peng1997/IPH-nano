...
class Ui_MainWindow(QObject):
    ...
    def setupUi(self, MainWindow):
        ...
        self.typeTree.setMinimumWidth(350)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(self._translate("MainWindow", "高通量测序分析"))
    ...
    def tree_click(self, item):
        ...
        if parent_ == '未知病原illumina测序数据分析' and item.text(0) == '可视化分析':
            data = {
                'task_type': '',
                'task_name': '',
                'sample_list': '',
